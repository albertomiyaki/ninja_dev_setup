# Service Manager - start/stop your services
...
function Get-FilteredServices {
    ...
    $filteredServices = Get-Service | Where-Object { 
        ...
        return $false
    } | Select-Object Name, DisplayName, Status, @{Name="Action"; Expression={
        if ($_.Status -eq "Running") { "Stop" } else { "Start" }
    }}
    ...
    <Grid>
        ...
        <Border Grid.Row="0" Background="#2d2d30" Padding="15">
            <Grid>
                ...
                <StackPanel Grid.Column="0">
                    ...
                    <TextBlock Text="Start and stop custom services" Foreground="#999999" Margin="0,5,0,0"/>
                </StackPanel>
        ...
        <Grid Grid.Row="1" Margin="15">
            ...
            <ListView x:Name="ServiceListView" Grid.Row="1" 
                ...
                <ListView.View>
                    <GridView>
                        <GridViewColumn Header="Service Name" Width="300">
                        ...
                        <GridViewColumn Header="Display Name" Width="420">
                            <GridViewColumn.CellTemplate>
                                <DataTemplate>
        ...
        <Border Grid.Row="2" Background="#F5F5F5" Padding="15" BorderThickness="0,1,0,1" BorderBrush="#DDDDDD">
            <Grid>
                ...
                <StackPanel Grid.Column="0">
                    ...
                    <TextBlock x:Name="SelectedServiceStatus" Text="" Foreground="#666666" FontSize="12" Margin="0,5,0,0"/>
                </StackPanel>
...
# Initial state - Toggle button disabled
$sync.ToggleButton.IsEnabled = $false
...
$sync.ServiceListView.Add_SelectionChanged({
    ...
    if ($selectedItem -ne $null) {
        ...
        $sync.SelectedServiceStatus.Text = "Status: $($selectedItem.Status) - $($selectedItem.Action) action available"
